                    ...
                    <div className="content">
                        <div className="flex flex-col gap-y-4">
                            <div className="flex pop-sub-custom flex-col lg:text-xl gap-y-2">
                                ...
                                <input type="text" placeholder='Text to find' name="find-text" id="find-text" className="input rounded-md w-72 h-12 lg:w-96 lg:h-16" onChange={handleOnChange1} value={props.searchText} />
                            </div>
                            <div className="flex pop-sub-custom flex-col lg:text-xl gap-y-2">
                                <label htmlFor="replace-text">Replace with</label>
                                <input type="text" placeholder='Text to be replaced' name="replace-text" id="replace-text" className="input rounded-md w-72 h-12 lg:w-96 lg:h-16" onChange={handleOnChange2} value={props.replaceWith} onKeyDown={handleKeyPress} />
                            </div>
